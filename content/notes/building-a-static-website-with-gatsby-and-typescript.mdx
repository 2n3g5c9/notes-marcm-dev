...
I went with Depfu as it offers more advanced update strategies, and a straightforward auto-merging process. The coverage
of the aforementioned automated checks gave enough confidence about the ability to identify breaking changes on a
specific dependency. Even if it breaks, rolling back is easy.
...
dependencies. We could argue this opens the door to automatically merging malicious code, but I'm not going to review
dozens of updates every week.
