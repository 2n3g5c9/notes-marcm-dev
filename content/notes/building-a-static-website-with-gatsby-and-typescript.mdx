...
* Keep up with [React](https://reactjs.org/)/[TypeScript](https://www.typescriptlang.org/) core concepts, and modern front-end web development workflows.
...
* Easy integration with React/TypeScript for modularity and aforementioned rationale.
* Adheres to [Jamstack](https://jamstack.org/) architecture principles (JavaScript, APIs & Markup) and renders [MDX](https://mdxjs.com/) (Markdown with embedded JSX).
* Bootstraps SEO, bundling, building, and many optimisation techniques (code splitting, image processing and serving ([WebP](https://developers.google.com/speed/webp) and/or [AVIF](https://aomedia.org/av1-features/get-started/)), preload/prefetch, tree shaking, etc.).
